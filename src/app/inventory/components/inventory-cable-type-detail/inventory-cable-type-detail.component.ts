...
export class InventoryCableTypeDetailComponent extends DetailPage<CableType> implements OnInit {
  ...
  protected async _loadData(id: number) {
    ...
    this.model = await this._inventoryApiService.getCableType(id).toPromise();
