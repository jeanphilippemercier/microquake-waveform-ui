...
export class InventorySensorTypeDetailComponent extends DetailPage<ISensorType> implements OnInit {
  ...
  protected async _loadData(id: number) {
    ...
    this.model = await this._inventoryApiService.getSensorType(id).toPromise();
